function Export-CatalogManifest {
    ...
    $profiles = @(
        ...
        [ordered]@{ Name = 'opinionated'; Description = 'The aggressive set plus personal-taste extras (tagged Profiles=@(''opinionated'')): reversed mouse scroll, Start web-search off, lock-screen Spotlight off, WSL, and OEM extras such as disabling the Waves MaxxAudio service.' }
    )
